...
func GenerateCsiRbdProvisionerCephClientName(generation int, uid types.UID) string {
	return fmt.Sprintf("%s-g%d-%v", csiRbdProvisionerCephUserKey, generation, uid)
}

func GenerateCsiRbdNodeCephClientName(generation int, uid types.UID) string {
	return fmt.Sprintf("%s-g%d-%v", csiRbdNodeCephUserKey, generation, uid)
}

func GenerateCsiCephFsProvisionerCephClientName(generation int, uid types.UID) string {
	return fmt.Sprintf("%s-g%d-%v", csiCephFsProvisionerCephUserKey, generation, uid)
}

func GenerateCsiCephFsNodeCephClientName(generation int, uid types.UID) string {
	return fmt.Sprintf("%s-g%d-%v", csiCephFsNodeCephUserKey, generation, uid)
}

func GenerateCsiNfsProvisionerCephClientName(generation int, uid types.UID) string {
	return fmt.Sprintf("%s-g%d-%v", csiNfsProvisionerCephUserKey, generation, uid)
}

func GenerateCsiNfsNodeCephClientName(generation int, uid types.UID) string {
